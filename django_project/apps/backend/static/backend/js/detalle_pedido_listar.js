$(function() {
    generarTabla('/configuracion//detalle_pedido/json/', function(data) {
...
function armarFila(index, instancia) {
    ...
    // Atributos
    fila += '<td> Detalle de Pedido Nº : ' + instancia.pk + '</td>';	        
    ...
    fila += '<td>' +
            ' <a href="/configuracion//detalle_pedido/' + instancia.pk + '/' +
            '" class="btn btn-info" title="Ver"><span class="glyphicon glyphicon-eye-open"></span></a>' +
            ' <a href="/configuracion//detalle_pedido/' + instancia.pk + '/editar/' +
