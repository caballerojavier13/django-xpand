$(function() {
    generarTabla('/configuracion//almacen_producto/json/', function(data) {
...
function armarFila(index, instancia) {
    ...
    // Atributos
    fila += '<td> AlmacenProducto Nº : ' + instancia.pk + '</td>';	        
    ...
    fila += '<td>' +
            ...
            ' <a href="/configuracion//almacen_producto/' + instancia.pk + '/editar/' +
