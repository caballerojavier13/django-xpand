$(function() {
    generarTabla('/configuracion//historico_precio/json/', function(data) {
...
function armarFila(index, instancia) {
    ...
    // Atributos
    fila += '<td> Histórico Precio Nº : ' + instancia.pk + '</td>';	        
    ...
    fila += '<td>' +
            ' <a href="/configuracion//historico_precio/' + instancia.pk + '/' +
            '" class="btn btn-info" title="Ver"><span class="glyphicon glyphicon-eye-open"></span></a>' +
            ' <a href="/configuracion//historico_precio/' + instancia.pk + '/editar/' +
