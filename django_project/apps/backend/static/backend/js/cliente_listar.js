$(function() {
    generarTabla('/configuracion/ventas/cliente/json/', function(data) {
...
;
    ...
    fila += '<td>' +
            ' <a href="/configuracion/ventas/cliente/' + instancia.pk + '/' +
            '" class="btn btn-info" title="Ver"><span class="glyphicon glyphicon-eye-open"></span></a>' +
            ' <a href="/configuracion/ventas/cliente/' + instancia.pk + '/editar/' +
