$(function() {
    generarTabla('/configuracion/ventas/detalle_venta/json/', function(data) {
...
function armarFila(index, instancia) {
    ...
    // Atributos
    fila += '<td> Detalle de Venta Nº : ' + instancia.pk + '</td>';	        
    ...
    fila += '<td>' +
            ' <a href="/configuracion/ventas/detalle_venta/' + instancia.pk + '/' +
            '" class="btn btn-info" title="Ver"><span class="glyphicon glyphicon-eye-open"></span></a>' +
            ' <a href="/configuracion/ventas/detalle_venta/' + instancia.pk + '/editar/' +
