$(function() {
    generarTabla('/configuracion/productos/categoría/json/', function(data) {
...
;
    ...
    fila += '<td>' +
            ' <a href="/configuracion/productos/categoría/' + instancia.pk + '/' +
            '" class="btn btn-info" title="Ver"><span class="glyphicon glyphicon-eye-open"></span></a>' +
            ' <a href="/configuracion/productos/categoría/' + instancia.pk + '/editar/' +
