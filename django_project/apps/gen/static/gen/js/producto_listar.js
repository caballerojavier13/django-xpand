$(function() {
    generarTabla('/configuracion/productos/producto/json/', function(data) {
...
if (instancia.fields.categoria != null) {
    fila += '<li role="presentation"><a role="menuitem" tabindex="-1" href="/configuracion/productos/categoria/' + instancia.fields.categoria +
'">Categoría</a></li>'
;
}
else {
    fila += '<li class="disabled" role="presentation"><a role="menuitem" tabindex="-1" href="#">Sin categoría</a></li>'
;
}
    ...
    fila += '<td>' +
            ' <a href="/configuracion/productos/producto/' + instancia.pk + '/' +
            '" class="btn btn-info" title="Ver"><span class="glyphicon glyphicon-eye-open"></span></a>' +
            ' <a href="/configuracion/productos/producto/' + instancia.pk + '/editar/' +
